...
export const EVENTS: Event[] = [
  {
    id: '1',
    title: '🎾 Torneo de Pádel Primavera',
    description: '¡Participa en nuestro torneo de pádel de primavera! Premios para los ganadores y descuentos especiales para participantes. Inscripciones abiertas hasta el 15 de octubre.',
  ...
  },
  {
    ...
    description: 'Aprovecha nuestro descuento especial del 50% en todas las canchas premium durante los fines de semana. Válido hasta el 30 de septiembre.',
